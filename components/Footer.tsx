        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="space-y-4">
              {/* Address */}
              <div className="flex items-start space-x-3 max-w-xs mx-auto sm:mx-0 sm:justify-start">
              ...
              {/* Phone */}
              <div className="flex items-center space-x-3 max-w-xs mx-auto sm:mx-0 sm:justify-start">
                ...
                <div className="flex-1 min-w-0">
                  <a href="tel:+27736457728" className="text-gray-400 hover:text-primary-400 transition-colors text-sm whitespace-nowrap">
                    +27 736457728
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 max-w-xs mx-auto sm:mx-0 sm:justify-start">
                ...
                <div className="flex-1 min-w-0">
                  <a href="mailto:lewisstevenmacoyo@gmail.com" className="text-gray-400 hover:text-primary-400 transition-colors text-sm break-words">
