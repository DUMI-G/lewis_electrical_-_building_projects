          ...
          <div className="text-center sm:text-left">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-center sm:justify-start space-x-3">
                ...
                <a href="tel:+27736457728" className="text-gray-400 hover:text-primary-400 transition-colors text-sm">
                  +27 736457728
                </a>
              </div>
              ...
              <div className="flex items-center justify-center sm:justify-start space-x-3">
                ...
                <a href="mailto:lewisstevenmacoyo@gmail.com" className="text-gray-400 hover:text-primary-400 transition-colors text-sm break-all">
