        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            <motion.div
              ...
              className="inline-block mb-6 px-4 py-2 bg-primary-600/20 backdrop-blur-sm rounded-full border border-primary-600/30"
            >
            ...
            <p className="text-lg sm:text-xl text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto md:mx-0">
            ...
            >
              <div className="text-center md:text-left">
                ...
                <div className="text-gray-400 text-sm leading-tight">Years<br />Experience</div>
              </div>
              <div className="text-center md:text-left">
                <div className="text-3xl sm:text-4xl font-bold text-white mb-2">500+</div>
                <div className="text-gray-400 text-sm leading-tight">Projects<br />Done</div>
              </div>
              <div className="text-center md:text-left">
                <div className="text-3xl sm:text-4xl font-bold text-white mb-2">100%</div>
                <div className="text-gray-400 text-sm leading-tight">Client<br />Satisfaction</div>
              </div>
            </motion.div>
          </motion.div>
